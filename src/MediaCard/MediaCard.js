  ...
  mediaRender () {
    ...
    if (this.props.titleRightMedia != null) {
      ...
      rightMedia = (<div className='row media-spacing'>
        ...
        <div className='col-xs-12 col-sm-12 col-md-3' style={{ paddingRight: '30px' }}>
          <img src={media.image} alt='big media' className='small-media pull-right' style={media.mediaStyle} />
        </div>
      </div>)
    }
    ...
    if (this.props.titleLeftMedia != null) {
      ...
      leftMedia = (<div className='row media-spacing'>
        <div className='col-xs-12 col-sm-12 col-md-3' style={{ left: '12px' }}>
